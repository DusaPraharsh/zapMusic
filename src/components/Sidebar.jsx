...
const Sidebar = () => {
  ...
  return (
    <>
      <div className="md:flex hidden flex-col w-[210px] px-4 bg-[#191624]">
        <img src={zapLogo} alt='logo' className='w-44 h-26 mt-0 object-contain' />
        <NavLinks />
      </div>
      ...
      ${mobileMenuOpen ? 'left-0' : '-left-full'}`}>
        <img src={zapLogo} alt='logo' className='w-44 h-26 object-contain' />
